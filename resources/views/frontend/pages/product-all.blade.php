                ...
                <div class="block-split__item block-split__item-content col-auto">
                    <div class="block">
                        <div class="products-view">
                            ...
                            @foreach($products->unique('cat_id') as $product)
                                <!-- Display category name -->
                                <div class="products-view__options view-options view-options--offcanvas--mobile mb-3 mt-3">
                                    <div class="view-options__body">
                                        <h6 class=""><a href="{{route('product-cat',$product->category->slug)}}">{{ $product->category->title }}</a> </h6>
                                        <div class="view-options__spring"></div>
                                    </div>
                                </div>

                                <!-- Product list for the current category -->
                                <div class="products-view__list products-list products-list--grid--4" data-layout="grid" data-with-features="false">
                                    ...
                                    <div class="products-list__content">
                                        @foreach($products->where('cat_id', $product->cat_id) as $productItem)
